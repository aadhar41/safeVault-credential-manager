          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              {formData.attachments.map(file => (
                <div key={file.id} className="group relative px-3 py-2 bg-indigo-50 border border-indigo-100 rounded-lg flex items-center gap-2">
                  <Paperclip size={14} className="text-indigo-500" />
                  <span className="text-xs text-indigo-700 font-medium truncate max-w-[120px]">{file.name}</span>
                  <button
              ...
              <label className="px-3 py-2 border-2 border-dashed border-slate-200 rounded-lg flex items-center gap-2 text-slate-400 hover:border-indigo-300 hover:text-indigo-500 cursor-pointer transition-colors">
                <Plus size={14} />
